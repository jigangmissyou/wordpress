...
class trx_addons_widget_cars_search extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		$maximized = isset($instance['maximized']) ? (int) $instance['maximized'] : 0;

		trx_addons_get_template_part('cpt/cars/tpl.widget.cars_search.php',
										'trx_addons_args_widget_cars_search',
										array_merge($args, compact('title', 'orderby', 'order', 'type', 'maximized'))
									);
	}
	...
	function update($new_instance, $old_instance) {
		...
		$instance['maximized'] = strip_tags($new_instance['maximized']);
...
//-------------------------------------------------------------
/*
[trx_widget_cars_search id="unique_id" title="Widget title" orderby="price" order="desc" maximized="0|1"]
*/
		...
		return apply_filters('trx_addons_sc_map', array(
				...
				"params" => array_merge(
					array(
						...
						array(
							"param_name" => "maximized",
							"heading" => esc_html__("Maximized only", 'trx_addons'),
							"description" => wp_kses_data( __("Always show full form", 'trx_addons') ),
							'save_always' => true,
							"std" => "0",
							"value" => array("Maximize form" => 1 ),
							"type" => "checkbox"
						)
					),
