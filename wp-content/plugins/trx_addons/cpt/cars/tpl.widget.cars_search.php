...
?><div
	...
	class="sc_form cars_search cars_search_<?php 
		...
		if ($trx_addons_args['maximized'] > 0) echo ' cars_search_opened';
...
?>>
	<form class="cars_search_form sc_form_form sc_form_custom <?php if ($form_style != 'default') echo 'sc_input_hover_'.esc_attr($form_style); ?>" action="<?php echo esc_url(get_post_type_archive_link( TRX_ADDONS_CPT_CARS_PT )); ?>" method="get">
		<div class="cars_search_basic"><?php
			...
			// Basic Submit button
			?><button class="cars_search_button trx_addons_icon-search" title="<?php esc_attr_e('Start search', 'trx_addons'); ?>"><?php echo esc_html('Search', 'trx_addons'); ?></button><?php
		...
		<div class="cars_search_advanced"><?php
			...
			trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
											...
											array_merge($trx_addons_args, array(
														'labels'      => true,
														'field_title' => __('Doors', 'trx_addons'),
														'field_name'  => 'cars_doors',
														'field_type'  => 'range',
														'field_value' => $params['cars_doors'],
														'field_req'   => false,
														'field_min'   => trx_addons_cpt_cars_get_min_max('doors_min'),
														'field_max'   => trx_addons_cpt_cars_get_min_max('doors_max'),
														'field_step'  => 1
														))
										);
			...
			trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
											...
											array_merge($trx_addons_args, array(
														'labels'      => true,
														'field_title' => __('Passengers', 'trx_addons'),
														'field_name'  => 'cars_passengers',
														'field_type'  => 'range',
														'field_value' => $params['cars_passengers'],
														'field_req'   => false,
														'field_min'   => trx_addons_cpt_cars_get_min_max('passengers_min'),
														'field_max'   => trx_addons_cpt_cars_get_min_max('passengers_max'),
														'field_step'  => 1
														))
										);
			...
			trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
											...
											array_merge($trx_addons_args, array(
														'labels'      => true,
														'field_title' => __('Luggage', 'trx_addons'),
														'field_name'  => 'cars_luggage',
														'field_type'  => 'range',
														'field_value' => $params['cars_luggage'],
														'field_req'   => false,
														'field_min'   => trx_addons_cpt_cars_get_min_max('luggage_min'),
														'field_max'   => trx_addons_cpt_cars_get_min_max('luggage_max'),
														'field_step'  => 1
														))
										);
